...
const UserBannerModal = ({ setEditBanner }) => {
  ...
  const updateBannerPhoto = async (e) => {
    e.preventDefault();
    setLoading(true);
    try {
    ...
    >
      ...
      >
        <div className="w-full justify-between items-center flex">
          <h2 className="text-xl font-semibold ">Kapak Fotoğrafını Güncelle</h2>
          <button
            onClick={() => setEditBanner(false)}
        ...
        <form onSubmit={updateBannerPhoto}>
